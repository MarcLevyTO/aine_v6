...
When running `pnpm create next-app@latest aine`, answer the `Would you like your code inside a 'src/' directory?` prompt with **No**. All other prompts: accept defaults (TypeScript, ESLint, Tailwind, App Router, Turbopack, `@/*` alias).

This keeps the repo structure shallow and matches all path references in this document.

### Complete Project Directory Structure

```
aine/
├── README.md                   # generated by create-next-app, light edits OK
├── package.json
├── pnpm-lock.yaml
├── next.config.ts              # generated, no edits in PoC
├── tsconfig.json               # generated, strict mode confirmed
├── tailwind.config.ts          # generated, no custom theme in PoC
├── postcss.config.mjs          # generated
├── eslint.config.mjs           # generated, no rule overrides in PoC
├── AGENTS.md                   # generated by create-next-app 2026, guides AI agents
├── .gitignore                  # generated
├── public/                     # generated; static assets — empty in PoC
│   └── (default favicon, etc.)
└── app/
    ├── layout.tsx              # generated; root layout, minimal edits
    ├── page.tsx                # the only client component holding state
    ├── globals.css             # generated; Tailwind directives
    ├── components/
...
Answer prompts as documented in the Project Structure section (notably: opt **out** of `src/`).
